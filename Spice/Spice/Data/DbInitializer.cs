...
namespace Spice.Data
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public async void Initialize()
        {
            ...
            {
                UserName = "shahed@email.com",
                Email = "shahed@email.com",
                Name = "Shahed Kaiser",
                EmailConfirmed = true,
                PhoneNumber = "01611916182"
            }, "Admin123*").GetAwaiter().GetResult();

            IdentityUser user = await _db.Users.FirstOrDefaultAsync(u => u.Email == "shahed@email.com");
